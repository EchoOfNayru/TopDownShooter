...
public class GameManager : MonoBehaviour {
    ...
    public void MoveRoom(string dir)
    {
        if (dir == "North")
        {
            ...
            player.transform.position = new Vector3(cam.transform.position.x, player.transform.position.y, cam.transform.position.z - 4.32f);
        }
        if (dir == "South")
        {
            cam.transform.position = new Vector3(cam.transform.position.x, cam.transform.position.y, cam.transform.position.z - 12);
        ...
        if (dir == "West")
        {
            ...
            player.transform.position = new Vector3(cam.transform.position.x + 8.5f, player.transform.position.y, cam.transform.position.z);
        }
        if (dir == "East")
        {
            cam.transform.position = new Vector3(cam.transform.position.x + 22, cam.transform.position.y, cam.transform.position.z);
